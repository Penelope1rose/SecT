	...
	if (retrieveLecturerInfo != null) {
		...
		%>
	        ...
	        <div class="form-group">
			  <label for="modCode">Module Code:&nbsp;<span class="glyphicon glyphicon-question-sign" aria-hidden="true" title="An assessment must be created for a particular module before you can add announcements"></span></label>
			  <select class="form-control" id="modCodedropdown" required>
			  	<option></option>
		<%
    	...
    	%>
			    <option><%=assessment.getModuleName()%> (<%=assessment.getModuleCode()%>)</option>
		<%
    		}
    	}
		%>
		<script type="text/javascript">
			$('#modCodedropdown').change(function () {
